...
draw_sprite_ext(s_block_move_icon,0,x+amnt+sprite_width/2,y+amnt+sprite_height/2,midle_size,midle_size,rot,c_white,1)
...
if spiked==true
{
	if spike_left==1
	{
		...
		for (var i=0;i<amt;i++)
		{
			draw_sprite(s_block_spike,0,x+amnt-sprite_get_width(s_block_spike),y+amnt+i*3)
		}
	...
	if spike_right==1
	{
		...
		for (var l=0;l<amt;l++)
		{
			draw_sprite(s_block_spike,1,x+amnt+sprite_width,y+amnt+l*3)
		}
	...
	if spike_up==1
	{
		...
		{
			draw_sprite(s_block_spike_up,0,x+amnt+j*3,y+amnt-sprite_get_height(s_block_spike_up))
		}
	...
	if spike_down==1
	{
		...
		{
			draw_sprite(s_block_spike_up,1,x+amnt+f*3,y+amnt+sprite_height)
		}
